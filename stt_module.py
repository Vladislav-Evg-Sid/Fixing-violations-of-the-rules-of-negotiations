...
if not os.path.exists("/content/drive/MyDrive/vosk-model-ru-0.42"):
    print("Please download the model from https://alphacephei.com/vosk/models and place it in the current directory.")
    exit(1)
...
model = Model("/content/drive/MyDrive/vosk-model-ru-0.42")
